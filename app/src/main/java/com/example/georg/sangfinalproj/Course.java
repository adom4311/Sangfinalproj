...
public class Course {
    ...
    public Course(int courseID, String courseUniversity, int courseYear, String courseTerm, String courseMajor, String courseArea, int courseGrade, String courseTitle, int courseCredit, int coursePersonnel, String courseProfessor, String courseTime, String courseRoom) {
